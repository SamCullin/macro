...
use outbound::reranker::TaskDedupReranker;

/// The production task-dedup service: OpenAI `text-embedding-3-small` embeddings,
/// a Postgres/pgvector store, and a provider-selected reranker. Consumers depend on this
...
pub type PgTaskDedupService =
    TaskDedupService<DIMS, TextEmbedding3Small, PgTaskVectorDb, TaskDedupReranker>;
